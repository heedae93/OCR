    ...
    def _get_default_config(self) -> Dict[str, Any]:
        ...
        return {
            "ocr": {
                ...
                "ppstructure_recognition_model": "PP-OCRv5_server_rec",
...
def create_legacy_config() -> Dict[str, Any]:
    ...
    return {
        ...
        'OCR_ENGINE': ocr_config.get('engine', 'pp_structure'),
        'PPSTRUCTURE_LAYOUT_MODEL': ocr_config.get('ppstructure_layout_model', 'PP-DocLayout-L'),
        'PPSTRUCTURE_RECOGNITION_MODEL': ocr_config.get('ppstructure_recognition_model', 'PP-OCRv5_server_rec'),
        'PPSTRUCTURE_USE_TABLE_RECOGNITION': ocr_config.get('use_table_recognition', True),
        'PPSTRUCTURE_TABLE_MODEL': ocr_config.get('table_model_name', 'SLANet_plus'),
        'PPSTRUCTURE_WIRELESS_TABLE_MODEL': ocr_config.get('wireless_table_model_name', 'SLANet'),
